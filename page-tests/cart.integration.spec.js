...
describe('Cart', () => {
  let server, result, spy, add, toggle, reset;
  ...
  it('should add css class "hidden" in the document', () => {
    render(<Cart />);

    expect(screen.getByTestId('cart')).toHaveClass('hidden');
  });

  it('should remove add css class "hidden" in the document', async () => {
  ...
  it('should call two times button close', async () => {
    await componentsAct(async () => {
      render(<Cart />);
